        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-user"></i> My Account</a>
                            </li>
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        {{-- <li><a href="{{ route('single.product', 1) }}">Single product</a></li> --}}
                        <li><a href="{{ route('cart.page') }}">Cart</a></li>
                        <li><a href="{{ route('testimonial') }}">Testimonial</a></li>
                        <li><a href="{{ route('messageUs') }}">Contact</a></li>
